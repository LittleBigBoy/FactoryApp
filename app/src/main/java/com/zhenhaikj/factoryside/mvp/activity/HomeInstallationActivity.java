...
//                mPresenter.AddOrder("2", "安装", userID, FBrandID, BrandName, FCategoryID, CategoryName, SubCategoryID, SubCategoryName , ProvinceCode, CityCode, AreaCode,DistrictCode, Address, Name, Phone, FaultDescription, OrderMoney, RecycleOrderHour, Guarantee, Extra, ExtraTime, ExtraFee, Num, AccessorySendState,null);
                break;
