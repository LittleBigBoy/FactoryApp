...
public class PendingReviewFragment extends BaseLazyFragment<AllWorkOrdersPresenter, AllWorkOrdersModel> implements View.OnClickListener, AllWorkOrdersContract.View {
    ...
    public static PendingReviewFragment newInstance(String param1, String param2) {
        PendingReviewFragment fragment = new PendingReviewFragment();
    ...
    protected void initData() {
        mRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(@NonNull RefreshLayout refreshLayout) {
                ...
                workOrderList.clear();
                pageIndex = 1;
                mPresenter.GetOrderInfoList(UserID, state, Integer.toString(pageIndex), "3");
            }
        });
    ...
    protected void initView() {
        ...
        mTvRemoteFeeReview.setSelected(true);
        state = "9";
        mPresenter.GetOrderInfoList(UserID, state, Integer.toString(pageIndex), "3");

        myClipboard = (ClipboardManager) mActivity.getSystemService(Context.CLIPBOARD_SERVICE);

        mRvPending.setLayoutManager(new LinearLayoutManagerWrapper(mActivity));
        ...
        mRvPending.setAdapter(mWorkOrderAdapter);
...
//                        mPresenter.UpdateOrderState(orderId,"-2");
    ...
    protected void setListener() {
        ...
        mTvRemoteFeeReview.setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.tv_remote_fee_review:
                mTvRemoteFeeReview.setSelected(true);
            ...
            case R.id.tv_timed_out:
                mTvRemoteFeeReview.setSelected(false);
