package com.emjiayuan.nll.widget;
...
public class GridDivider extends RecyclerView.ItemDecoration {
    ...
    public GridDivider(int space, int color) {
        this.space = space;
        this.color = color;
    ...
    public GridDivider(int space, int color,int type) {
        this.space = space;
        this.color = color;
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(color);
    ...
    public GridDivider(int space, Drawable mDivider) {
        this.space = space;
